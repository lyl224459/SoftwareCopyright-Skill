...
4. 系统要求：用表格说明最低配置和推荐配置；Web 项目写浏览器、网络和服务访问要求；桌面项目写操作系统、处理器、内存、存储和分辨率；CLI 项目写操作系统、终端环境和依赖运行时；移动项目写操作系统版本和设备要求。
5. 具体功能操作：从第 5 章开始，按真实页面/窗口/命令或核心流程逐章说明。Web 项目按页面写，桌面项目按窗口/面板写，CLI 项目按命令/子命令写，移动项目按屏幕写。每章覆盖使用场景、用途、进入位置、可见内容、用户动作、输入限制或异常提示、操作结果和截图预留。
